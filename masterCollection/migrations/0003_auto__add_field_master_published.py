...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Master.published'
        db.add_column(u'masterCollection_master', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Master.published'
        db.delete_column(u'masterCollection_master', 'published')
