...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Master.address'
        db.add_column(u'masterCollection_master', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Master.address'
        db.delete_column(u'masterCollection_master', 'address')
